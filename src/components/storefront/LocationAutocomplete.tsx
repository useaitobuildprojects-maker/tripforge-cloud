      ...
      <AnimatePresence>
        {open && query.length >= 1 && allResults.length > 0 && (
          <motion.div
            ...
            className="absolute left-0 right-0 sm:right-auto top-[calc(100%+12px)] z-50 bg-white rounded-md shadow-[0_20px_50px_-12px_rgba(15,23,42,0.25)] border border-[#e5e7eb] max-h-[420px] overflow-y-auto w-auto min-w-full sm:w-[460px] sm:max-w-[92vw]"
          >
