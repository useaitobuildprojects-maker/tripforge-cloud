  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-8 w-8 inline-flex items-center justify-center rounded-md border border-border/60 bg-background text-foreground/70 hover:text-foreground hover:bg-muted hover:border-border transition-colors",
        ),
        ...
        day: "h-9 w-9 p-0 font-normal text-sm rounded-md inline-flex items-center justify-center transition-colors hover:bg-muted hover:text-foreground aria-selected:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
        ...
        day_outside:
          "day-outside text-muted-foreground/40 aria-selected:bg-primary/10 aria-selected:text-muted-foreground aria-selected:opacity-50",
