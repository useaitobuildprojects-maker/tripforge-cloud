              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="time" value={pickupTime} onChange={(e) => setPickupTime(e.target.value)} className="w-[150px] h-11 rounded-lg border border-border bg-background pl-10 pr-3 text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-shadow" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-3 items-start">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Clock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground pointer-events-none" />
                    <input type="time" value={dropoffTime} onChange={(e) => setDropoffTime(e.target.value)} className="w-[150px] h-11 rounded-lg border border-border bg-background pl-10 pr-3 text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-shadow" />
                  </div>
                </div>
              </div>
            </div>
